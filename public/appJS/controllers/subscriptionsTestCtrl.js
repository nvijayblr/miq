'use strict';
backMe.controller('subscriptionsTestCtrl', ['$scope', 'BaseServices', '$timeout', '$state', 'appConstant', function(_scope, _services, _timeout, _state, _appConstant){

	console.log('subscriptionsTestCtrl');
