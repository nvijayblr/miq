'use strict';
backMe.controller('courseCtrl', ['$scope', 'BaseServices', '$timeout', '$state', 'appConstant', function(_scope, _services, _timeout, _state, _appConstant){
	...
	_scope.init = function() {
		_services.http.serve({
			method: 'GET',
			url: _appConstant.baseUrl + 'views/courses/' + _scope.courseCode +'?userId='+_scope.loggedUserId
		}, function(data){
			_scope.course = data;
